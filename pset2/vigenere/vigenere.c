...
int main(int argc, string argv[])
{
    ...
    // check that each character in the valid command line argument (i.e. the key)
    ...
    for (int i=0 ; i<key_length ; i++)
    {
        ...
        {
            printf("Error. You must enter only alphabetic characters.\n");
            return 1;
        }
    }
